...
class D3DUAL_OT_appliance_report(bpy.types.Operator):
    '''
    ...
    '''
    bl_idname='d3dual.appliance_report'
    bl_label="Appliance Report"
    ...
    def execute(self,context):
        ...
        Report.write("D3DualArch Appliance Report")
        Report.write("\n")
        Report.write("\n")
        
        Report.write("D3SDualArch Version: " + str(bl_info["version"]))
        Report.write("\n")
        ...
        Report.write("Designer Name: \n" )
        
        Report.write("\n")
        Report.write("\n")
        
        Report.write("#############################\n")
        Report.write("## Manufactruing           ##\n")
        Report.write("#############################\n")
        Report.write("\n")
        Report.write("\n")
        
        Report.write("Printer Brand: \n" )
        Report.write("Printer Model: \n" )
        Report.write("Printer SN: \n" )
        
        
        Report.write("Resin Brand: \n" )
        Report.write("Printer Type: \n" )
        Report.write("Resin Batch ID: \n" )
        
        Report.write("Post Cure Time: \n" )
        Report.write("Post Cure Temp: \n" )
        Report.write("Post Cure Wavelength: \n" )
        
        
        Report.write("#############################\n")
        Report.write("#### Appliance Properties ######\n")
        Report.write("#############################\n")
        #Report.write("\n")
        ...
        #Report.write("\n")
        if splint.max_refractory_model_complete:
            Report.write("Maxillary Shell Thickness: " + str(splint.max_shell_thickness)[0:6])
            Report.write("\n")
            Report.write("Madndibular Shell Thickness : " + str(splint.mand_shell_thickness)[0:6])
            Report.write("\n")
            Report.write("Maxillary Offset Spacer: " + str(splint.max_passive_value)[0:6])
            Report.write("\n")
            Report.write("Maxillary Undercut: " + str(splint.max_undercut_value)[0:6])
            Report.write("\n")
            Report.write("Mandibular Offset Spacer: " + str(splint.mand_passive_value)[0:6])
            Report.write("\n")
            Report.write("Mandibular Undercut: " + str(splint.mand_undercut_value)[0:6])
            Report.write("\n")
        else:
...
def register():
    bpy.utils.register_class(D3DUAL_OT_appliance_report)

def unregister():
    bpy.utils.unregister_class(D3DUAL_OT_appliance_report)