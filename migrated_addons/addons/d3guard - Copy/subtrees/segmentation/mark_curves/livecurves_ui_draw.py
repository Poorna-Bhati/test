...
from .livecurves_datastructure import InputPoint, CurveNode, SplineSegment
...
class Livecurves_UI_Draw():
    ...
    def draw_3D_stuff(self):
        ...
        if len(self.expected_dies):
            locs = [ob.matrix_world.to_translation() for ob in self.expected_dies]
           
            draw3d_points(locs, purple, 10, view_loc, view_ortho)
