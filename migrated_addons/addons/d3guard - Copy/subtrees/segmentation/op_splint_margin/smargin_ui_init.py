...
class Polytrim_UI_Init():
    def ui_setup(self):
        ...
        def mode_change_update_menus():
            ...
            if m == 'spline':
                win_obvious_instructions.hbf_title.set_label('Draw the Perimeter of the Splint')
            elif m == 'seed':
        ...
        win_obvious_instructions = self.wm.create_window('Draw the Perimeter of the Splint', {'pos':8, "vertical":False, "padding":15, 'movable':True, 'bgcolor':(0.50, 0.50, 0.50, 0.5), 'border_color':(0.50, 0.50, 0.50, 0.9), "border_width":4.0})
        ...
        info = self.wm.create_window('Splint Margin Help', {'pos':9, 'movable':True, 'bgcolor':(0.50, 0.50, 0.50, 0.90)})
