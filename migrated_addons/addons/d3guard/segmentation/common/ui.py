...
class UI_Window(UI_Padding):
    ...
    def __init__(self, title, options):
        ...
        self.border_color   = options.get('border_color', (0.1,0.1,0.1,0.75))
        self.border_width   = options.get('border_width', 1.0)
    ...
    def draw_postpixel(self):
        ...
        self.drawing.line_width(self.border_width)
        bgl.glColor4f(*self.border_color)
        bgl.glBegin(bgl.GL_LINE_STRIP)
        bgl.glVertex2f(l,t)
        bgl.glVertex2f(l,t-h)
        bgl.glVertex2f(l+w,t-h)
