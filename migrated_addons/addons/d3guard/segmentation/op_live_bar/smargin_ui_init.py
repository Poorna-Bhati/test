...
class Polytrim_UI_Init():
    def ui_setup(self):
        ...
        win_tools = self.wm.create_window('Live Bar Info', {'pos':7, 'movable':True, 'bgcolor':(0.50, 0.50, 0.50, 0.90)})

        precut_container = win_tools.add(ui.UI_Container())
        precut_container.rounded_background = True
        
        precut_tools = precut_container.add(ui.UI_Frame('Mark Curves', fontsize=16))
        ...
        container = precut_container.add(ui.UI_Frame('Rim Tools', fontsize=16))
