...
from ..common.ui import Drawing, UI_Collapsible
...
class Livecurves_UI_Init():
    def ui_setup(self):
        ...
        precut_tools.add(ui.UI_Button('Transparent Mode', self.set_2d_mode, margin = 5))
        ...
        #rim_alpha = options.add(ui.UI_Number("Rim Opacity", rim_alpha_getter, rim_alpha_setter, update_multiplier= .005))
        ...
        #fuse_rim_button = options.add(ui.UI_Button('Fuse Rim', self.fuse_rim_activate, margin=5))
