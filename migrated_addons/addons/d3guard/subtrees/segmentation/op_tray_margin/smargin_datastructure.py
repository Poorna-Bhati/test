...
#dependenceis appropriately linked to the subtress
from ...bmesh_utils.bmesh_utilities_common import grow_selection_to_find_face, flood_selection_faces, edge_loops_from_bmedges_old, edge_loops_from_bmedges, flood_selection_by_verts, flood_selection_edge_loop, ensure_lookup
from ...bmesh_utils.bmesh_utilities_segmentation import face_region_boundary_loops, bmesh_loose_parts_faces
...
#things specific to the segmentation module
...
#old dependencies not harmonized with subtrees
...
################33 ORIGINAL FUNCTION  ################################            
    ...
    def add_seed_pre_cut(self, face_ind, world_loc, local_loc):
        ...
        print('this patch has %i faces' % len(new_patch.patch_faces))
        self.net_ui_context.bme.to_mesh(self.net_ui_context.ob.data)
