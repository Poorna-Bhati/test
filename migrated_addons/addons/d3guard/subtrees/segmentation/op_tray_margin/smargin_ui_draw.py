...
from .smargin_datastructure import InputPoint, CurveNode, SplineSegment
...
class Polytrim_UI_Draw():
    ...
    def draw_postview(self):
        ...
        #if self._nav or self._ui: return  #TODO ADDON_COMMON API HARMONY
    ...
    def draw_2D_stuff(self):
        ...
        # skip the rest of the drawing if user is navigating or doing stuff with ui
        #if self._nav or self._ui: return  #TODO ADDON_COMMON API
        ...
        if self._state != 'segmentation':
            ...
            for seg in self.input_net.segments:
                ...
                if seg.bad_segment and not len(seg.path) > 2:
                    draw3d_polyline([seg.ip0.world_loc, seg.ip1.world_loc], red, 2, view_loc, view_ortho)
