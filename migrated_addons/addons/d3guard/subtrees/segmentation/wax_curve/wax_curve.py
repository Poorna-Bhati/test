...
#ModalOperator
class D3DENTURE_live_wax_curves(WaxCurve_States, WaxCurve_UI_Init, WaxCurve_UI_Tools, WaxCurve_UI_Draw, CookieCutter):
    ''' Cut Mesh Polytrim Modal Editor '''
    ''' Note: the functionality of this operator is split up over multiple base classes '''

    operator_id    = "d3denture.wax_live_curves"    # operator_id needs to be the same as bl_idname
                                            # important: bl_idname is mangled by Blender upon registry :(
    bl_idname      = "d3denture.wax_live_curves" 
