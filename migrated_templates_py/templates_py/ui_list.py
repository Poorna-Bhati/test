...
The correct Blender 4.4 compatible code for defining a boolean property is:
...
Key changes:
- Use the **annotation syntax** (`:`) instead of assignment (`=`).
- The **options** argument is no longer required for standard properties and should be omitted.
